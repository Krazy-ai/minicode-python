...
# ---------------------------------------------------------------------------
#
# 这些分词与 BM25 原语已抽取到共享模块 ``minicode/knowledge/bm25.py``，
# 供 memory 与 knowledge 两个子系统复用。此处 re-import 保持向后兼容：
# 仍可通过 ``minicode.memory.memory`` 访问这些符号。

from minicode.knowledge.bm25 import (  # noqa: E402
    _BM25_B,
    _BM25_K1,
    _CJK_BIGRAM_RE,
