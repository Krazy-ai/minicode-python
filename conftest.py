...
# Manual smoke/integration utilities from earlier development rounds have
# been moved to archive/legacy-tests/. Normal pytest coverage lives under tests/.
collect_ignore_glob = [
    "benchmarks/*.py",
    "archive/**/*.py",
]
...
def mock_memory_search():
    ...
    def mock_search(query, scope=None, limit=20, min_relevance=0.1):
        from minicode.memory.memory import MemoryEntry, MemoryScope
        return [
